...
<table width="799" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC" class="table" >
      <tr>
        <td height="27" colspan="7" align="left" bgcolor="#FFFFFF" class="bg_tr">&nbsp;后台管理&nbsp;&gt;&gt;&nbsp;图书管理</td>
      </tr>
      <tr>
...
<a href="book_update.php?id=<?php echo $rows['id'] ?>" class="trlink">修改</a>&nbsp;&nbsp;<a href="book_del.php?id=<?php echo $rows['id'] ?>" class="trlink">删除</a></td>
</tr>
	<?php
	}
?>
