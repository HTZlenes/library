  ...
  <ul id="navigation">
    <li> <a class="head">系统设置</a>
	 ...
	 <li><a class="head">图书管理</a>
       <ul>
        <li><a href="list.php" target="rightFrame">图书管理</a></li>
	 ...
	 <li><a class="head">查询统计</a>
       <ul>
        ...
        <li><a href="number.php" target="rightFrame">用户统计</a></li>
      </ul>
    </li>
    <li> <a class="head">版本信息</a>
      <ul>
        <li>
          <div align="center"><a href="ly_right.php" target="rightFrame">V1.0</a></div>
        </li>
      </ul>
    </li>
  </ul>
